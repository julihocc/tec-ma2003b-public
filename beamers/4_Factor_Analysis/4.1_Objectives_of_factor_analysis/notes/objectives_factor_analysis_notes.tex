...
% Reuse MA2003B branding colors from the beamer theme
\definecolor{tecblue}{RGB}{0,88,170}
\definecolor{tecorange}{RGB}{255,122,0}

% Helper commands for colored note titles
...
\begin{document}
% Render a colored title block (avoid coloring the PDF metadata)
\begingroup
  \centering
